...
(function (Net) {
    ...
    var Model = /** @class */ (function () {
        ...
        Model.prototype.getLayer = function (name) {
            return this.layers.get(name);
        };
        Model.prototype.setInputDimensions = function (width, height, depth) {
        ...
        Model.prototype.layerIterator = function (iteratorFn, params) {
            var _this = this;
        ...
        Model.prototype.forward = function (V, is_training, params) {
        ...
        Model.prototype.backward = function (y, params) {
            if (params === void 0) { params = {}; }
            params.reverse = true;
            var loss;
            this.layerIterator(function (layer, i, parents) {
        ...
        Model.prototype.debugStructure = function () {
            var numParams = 0;
            var f = d3.format('s');
            var f2 = d3.format(',d');
            var numLayers = 0;
...
(function (Net) {
    ...
    (function (Layers) {
        var nj = NumJS;
        var ConcatLayer = /** @class */ (function (_super) {
            __extends(ConcatLayer, _super);
            function ConcatLayer(opt) {
                var _this = _super.call(this, opt || {}) || this;
                _this.layer_type = 'concat';
                _this.axis = Net.getopt(opt, ['axis'], 1);
                _this.updateDimensions(opt.pred);
                return _this;
            }
...
(function (Net) {
    ...
    (function (Layers) {
        var nj = NumJS;
        var ConvLayer = /** @class */ (function (_super) {
            ...
            function ConvLayer(opt) {
                ...
                _this.pad = Net.getopt(opt, ['pad'], 0);
                // Convolution groups from AlexNet
                _this.conv_groups = Net.getopt(opt, ['group'], 1);
                _this.l1_decay_mul = Net.getopt(opt, ['l1_decay_mul'], 0.0);
                _this.l2_decay_mul = Net.getopt(opt, ['l2_decay_mul'], 1.0);
                _this.updateDimensions(opt.pred);
                // initialize bias
                var bias = Net.getopt(opt, ['bias_pref'], 0.0);
                _this.biases = new Net.Vol(1, 1, _this.out_depth, bias);
                // initialize filters
                _this.filters = [];
                var f_depth = Math.ceil(_this.in_depth / _this.conv_groups);
                for (var i = 0; i < _this.out_depth; ++i) {
                    _this.filters.push(new Net.Vol(_this.sx, _this.sy, f_depth, 0.0));
                }
                return _this;
            }
    ...
    (function (Layers) {
        ...
        var DropoutLayer = /** @class */ (function (_super) {
            ...
            function DropoutLayer(opt) {
                ...
                _this.drop_prob = Net.getopt(opt, ['drop_prob'], 0.5);
                _this.updateDimensions(opt.pred);
                return _this;
            }
...
(function (Net) {
    ...
    (function (Layers) {
        var nj = NumJS;
        var FullyConnectedLayer = /** @class */ (function (_super) {
            ...
            function FullyConnectedLayer(opt) {
                ...
                _this.out_depth = opt.num_neurons !== undefined ? opt.num_neurons : opt.filters;
                // optional 
                _this.l1_decay_mul = Net.getopt(opt, ['l1_decay_mul'], 0.0);
                _this.l2_decay_mul = Net.getopt(opt, ['l2_decay_mul'], 1.0);
                _this.updateDimensions(opt.pred);
                ...
                _this.filters = [];
                for (var i = 0; i < _this.out_depth; ++i) {
                    _this.filters.push(new Net.Vol(1, 1, _this.num_inputs, 0.0));
                }
                if (opt.filters !== undefined) {
                    for (var i = 0; i < _this.out_depth; ++i) {
                        _this.filters[i].w.set(opt.filters[i]);
                    }
                }
                if (opt.biases !== undefined) {
                    _this.biases.w.set(opt.biases);
                }
                return _this;
            }
        ...
        Layers.FullyConnectedLayer = FullyConnectedLayer;
    })(Layers = Net.Layers || (Net.Layers = {}));
})(Net || (Net = {}));
/// <reference path="./BaseLayer.ts" />
var Net;
    ...
    (function (Layers) {
        ...
        var InputLayer = /** @class */ (function (_super) {
            ...
            function InputLayer(opt) {
                ...
                // required: depth
                _this.in_depth = Net.getopt(opt, ['in_depth', 'out_depth', 'depth'], 0);
                // optional: default these dimensions to 1
                _this.in_sx = Net.getopt(opt, ['in_sx', 'out_sx', 'sx', 'width'], 1);
                _this.in_sy = Net.getopt(opt, ['in_sy', 'out_sy', 'sy', 'height'], 1);
...
(function (Net) {
    ...
    (function (Layers) {
        ...
        var LocalResponseNormalizationLayer = /** @class */ (function (_super) {
        ...
        Layers.LocalResponseNormalizationLayer = LocalResponseNormalizationLayer;
    })(Layers = Net.Layers || (Net.Layers = {}));
})(Net || (Net = {}));
/// <reference path="./BaseLayer.ts" />
var Net;
(function (Net) {
    ...
    (function (Layers) {
        ...
        var MaxoutLayer = /** @class */ (function (_super) {
            __extends(MaxoutLayer, _super);
            function MaxoutLayer(opt) {
                var _this = _super.call(this, opt || {}) || this;
                _this.layer_type = 'maxout';
                // required
                _this.group_size = opt.group_size !== undefined ? opt.group_size : 2;
                _this.updateDimensions(opt.pred);
                return _this;
            }
        ...
        Layers.MaxoutLayer = MaxoutLayer;
    })(Layers = Net.Layers || (Net.Layers = {}));
})(Net || (Net = {}));
/// <reference path="./BaseLayer.ts" />
var Net;
...
(function (Net) {
    ...
    (function (Layers) {
        ...
        var RegressionLayer = /** @class */ (function (_super) {
        ...
        Layers.RegressionLayer = RegressionLayer;
    })(Layers = Net.Layers || (Net.Layers = {}));
})(Net || (Net = {}));
/// <reference path="./BaseLayer.ts" />
var Net;
(function (Net) {
    ...
    (function (Layers) {
        ...
        var ReluLayer = /** @class */ (function (_super) {
...
(function (Net) {
    ...
    (function (Layers) {
        ...
        // so penalizes \sum_i(||x_i - y_i||^2), where x is its input
        // and y is the user-provided array of "correct" values.
        var SVMLayer = /** @class */ (function (_super) {
...
(function (Net) {
    ...
    (function (Layers) {
        ...
        var SigmoidLayer = /** @class */ (function (_super) {
        ...
        Layers.SigmoidLayer = SigmoidLayer;
    })(Layers = Net.Layers || (Net.Layers = {}));
})(Net || (Net = {}));
/// <reference path="./BaseLayer.ts" />
var Net;
(function (Net) {
    ...
    (function (Layers) {
        ...
        var SoftmaxLayer = /** @class */ (function (_super) {
        ...
        Layers.SoftmaxLayer = SoftmaxLayer;
    })(Layers = Net.Layers || (Net.Layers = {}));
})(Net || (Net = {}));
/// <reference path="./BaseLayer.ts" />
var Net;
(function (Net) {
    ...
    (function (Layers) {
        ...
        var TanhLayer = /** @class */ (function (_super) {
...
var Parser;
(function (Parser) {
    var BinaryprotoParser = /** @class */ (function (_super) {
...
var Parser;
(function (Parser) {
    var BlobProtoParser = /** @class */ (function (_super) {
...
var Parser;
(function (Parser) {
    var PrototxtParser = /** @class */ (function (_super) {
...
(function (Net) {
    var CaffeModel = /** @class */ (function (_super) {
        ...
        CaffeModel.prototype.caffeLayerToJs = function (layerOpt) {
            ...
            switch (layerOpt.type.toLowerCase()) {
                case 'input':
                    ...
                    layer = new Net.Layers.InputLayer(opt);
                    break;
                case 'conv':
                case 'convolution':
                    ...
                    layer = new Net.Layers.ConvLayer(opt);
                    break;
                case 'lrn':
                ...
                case 'innerproduct':
                    ...
                    opt.l1_decay_mul = p && p.length && p[0].decay_mult !== undefined ? +p[0].decay_mult : 0.0;
                    opt.l2_decay_mul = p && p.length && p[1].decay_mult !== undefined ? +p[1].decay_mult : 1.0;
                    layer = new Net.Layers.FullyConnectedLayer(opt);
                    break;
                case 'softmax':
                    layer = new Net.Layers.SoftmaxLayer(opt);
                    break;
                case 'relu':
                    layer = new Net.Layers.ReluLayer(opt);
                    break;
                case 'sigmoid':
                    layer = new Net.Layers.SigmoidLayer(opt);
                    break;
                case 'tanh':
                    layer = new Net.Layers.TanhLayer(opt);
                    break;
                default:
        ...
        CaffeModel.prototype.createLayers = function (model, layers, makeInput) {
            ...
            if (makeInput) {
                this.layers.set('data', new Net.Layers.InputLayer({
                    name: 'data',
...
(function (Utils) {
    var nj = NumJS;
    var im = ImgJS;
    var ActivationDrawer = /** @class */ (function (_super) {
...
/// <reference path="Parser/_module.ts" />
/// <reference path="Net/_module.ts" />
/// <reference path="Utils/_module.ts" /> 
